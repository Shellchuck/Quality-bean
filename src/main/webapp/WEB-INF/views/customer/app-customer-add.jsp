...
<head>
    ...
    <title>Quality Bean - Customer form</title>
                                            ...
                                            <div class="p-5">
                                                ...
                                                <form:form method="post" modelAttribute="customer">
                                                    <div class="form-group">
                                                        <form:input path="name" placeholder="Customer Name"/><br/>
                                                        <form:errors path="name" cssClass="error"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <form:input path="address" placeholder="Customer Address" /><br/>
                                                        <form:errors path="address" cssClass="error"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <form:input path="contactName" placeholder="Contact Personal Data"/><br/>
                                                        <form:errors path="contactName" cssClass="error"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <form:input path="email" placeholder="Contact Email"/><br/>
                                                        <form:errors path="email" cssClass="error"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <form:input path="phoneNo" placeholder="Contact Phone number"/><br/>
                                                        <form:errors path="phoneNo" cssClass="error"/>
                                                    </div>
                                                    <form:hidden path="claims"/>
                                                    <div align="center">
